            ...
            <div className={classes.questionpaperandcontrolswrapper}>
              ...
              <div className={classes.questionpapercontrols}>
                <div className={classes.questionpapercontrolsrowone}>
                  ...
                  <Button type="primary" icon={<UndoOutlined />} size="small" onClick={() => this.clearAnswer(this.state.selectedOption, this.state.currentquestionindex)}>Clear</Button>
                ...
                <div className={classes.questionpapercontrolsrowtwo}>
                  <Button type="primary" icon={<LeftOutlined />} size="small" disabled={this.state.currentquestionindex === 0} onClick={this.previousQuestion}>Previous</Button>
            ...
            <div className={classes.questionanswerinformationwrapper}>
              <div className={classes.questionanswercount}>
                <div className={classes.aligncenter}>
                  <div className={classes.questionnotvisited}><div>{this.state.qnvc}</div></div>
                  <span >Questions Not Visited</span>
                </div>
                <div className={classes.aligncenter}>
                  <div className={classes.questionanswered}><div>{this.state.qac}</div></div>
                  <span>Questions Answered</span>
                </div>
                <div className={classes.aligncenter}>
                  <div className={classes.questioninreview}><div>{this.state.qirc}</div></div>
                  <span>Questions In Review</span>
                </div>
                <div className={classes.aligncenter}>
                  <div className={classes.questionnotanswered}><div>{this.state.qnac}</div></div>
              ...
              <div className={classes.questionanswernavigation}>
                {this.state.questions.map((e, i) => {
                  ...
                  return <QuestionNavigation click={() => this.navigationClick(e, i)} useranswer={this.state.answers[i]} key={i} qa={e} ind={i} cqind={this.state.currentquestionindex} />;
                })}
              </div>
            </div>
          </React.Fragment>)}
